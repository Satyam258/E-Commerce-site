...
const Footer = () => {
  return (
    <footer className='border-t py-12'>
        ...
        gap-8 px-4 lg:px-0'>
          <div>
            ...
            <p className='text-gray-500 mb-4'>
              Be the first to hear about products, exclusive events,and 
              online offers.
            </p>
            ...
            <form className='flex'>
              ...
              <button type='submit'
              className='bg-black text-white px-6 text-sm rounded-r-md hover:bg-gray-800'>Subscribe</button>
            </form>
          </div>
          {/* Shop links */}
        ...
        {/* Footer Bottom */}
        <div className='container mx-auto mt-12 px-4 lg:px-4 lg:px-4 border-t border-gray-200 pt-6'>
